    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              Discover authentic local experiences with verified hosts across Southeast Asia.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/become-host" className="text-gray-400 hover:text-white transition-colors">Become a Host</Link></li>
              <li><Link href="/about" className="text-gray-400 hover:text-white transition-colors">About Us</Link></li>
              <li><Link href="/business-collaboration" className="text-gray-400 hover:text-white transition-colors">Business Collaboration</Link></li>
              <li><Link href="/affiliate-program" className="text-gray-400 hover:text-white transition-colors">Affiliate Program</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 LocallyTrip.com. All rights reserved.
          </p>
