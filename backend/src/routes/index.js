...
const featuredExperienceRoutes = require('./featuredExperienceRoutes');
const featuredCityRoutes = require('./featuredCityRoutes');
const featuredStoryRoutes = require('./featuredStoryRoutes');
...
router.use('/featured-experiences', featuredExperienceRoutes);
router.use('/featured-cities', featuredCityRoutes);
router.use('/featured-stories', featuredStoryRoutes);
